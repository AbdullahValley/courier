            ...
            <article> 
                ...
                <section class="banner mask-overlay pad-120 white-clr">
                    <div class="container theme-container rel-div">
                        <img class="pt-10 effect animated fadeInLeft" alt="" src="../../assets/front/img/icons/icon-1.png" />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us">
                                    ...
                                    <ul class="feature">
                                        <li> 
                                            <img alt="" src="../../assets/front/img/icons/icon-2.png" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" />
                                        ...
                                        <li> 
                                            <img alt="" src="../../assets/front/img/icons/icon-3.png" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" />
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                        ...
                                        <li> 
                                            <img alt="" src="../../assets/front/img/icons/icon-4.png" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" />
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <img alt="" src="../../assets/front/img/block/about-img.png" class="wow slideInRight" data-wow-offset="50" data-wow-delay=".20s" />
                            </div>
                        </div>
                    </div>
                </section>
...
<!-- Booking your parsel -->
					...
					<section class="calculate pt-100">
						<div class="theme-container container">  
							...
							<div class="row">
								...
								<div class="col-md-6">   
									<div class="pad-10"></div>
									<h2 class="section-title pb-10 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" > Booking Now.. </h2>
									<p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">Please Booking your parsel	</p>
									<div class="calculate-form">
										<form class="row">
											<div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
												<div class="col-sm-3"> <label class="title-2">Courier Catagory: </label></div>
												<div class="col-sm-9"> <input data-bind="in:value, f: float" data-name="height" type="text" placeholder="" class="form-control"> </div>
											</div>
											<div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
												<div class="col-sm-3"> <label class="title-2"> width (cm): </label></div>
                ...
                <section class="steps-wrap mask-overlay pad-80">                
                    ...
                    <div class="step-img wow slideInRight" data-wow-offset="50" data-wow-delay=".20s"> <img src="../../assets/front/img/block/step-img.png" alt="" /> </div>
                </section>
                <!-- /.Steps -->
                        ...
                        <div class="row">
                            <div class="col-md-11 col-md-offset-1">
                                ...
                                <div class="delivery-img pt-10">
                                    <img alt="" src="../../assets/front/img/block/delivery.png" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-slider no-pagination pad-120">
                            <div class="item">
                                <div class="testimonial-img darkclr-border theme-clr font-2 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                    <img alt="" src="../../assets/front/img/block/testimonial-1.png" />
                                    <span>,,</span>
                                </div>
